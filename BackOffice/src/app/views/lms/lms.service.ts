...
export class LMSService { UpdatePatientLabTest(value: PatientLabTestVM) {
  return this.http.put(Globals.BASE_API_URL + 'PatientLabTest', value);
}
GetPatientLabTestById(ClientId: number): Observable<any> {
  return this.http.get<PatientLabTestVM>(Globals.BASE_API_URL + 'PatientLabTest/' + ClientId).pipe()
}
SearchPatientLabTest(value: PatientLabTestVM): Observable<PatientLabTestVM[]> {
  return this.http.post<PatientLabTestVM[]>(Globals.BASE_API_URL + 'PatientLabTest/Search', value).pipe();
}
GetPatientLabTest(): Observable<PatientLabTestVM[]> {
  return this.http.get<PatientLabTestVM[]>(Globals.BASE_API_URL + 'PatientLabTest').pipe();
}
SavePatientLabTest(value: PatientLabTestVM): Observable<any> {
  return this.http.post(Globals.BASE_API_URL + 'PatientLabTest', value);
}
DeletePatientLabTest(ClientId: number) {
  return this.http.delete(Globals.BASE_API_URL + 'PatientLabTest/' + ClientId);
}
...
/* 
  UpdateUserAd(value: UserAdVM) {
    return this.http.put(Globals.BASE_API_URL + 'User', value);
  }
  GetUserAdById(id: number): Observable<UserAdVM> {
    return this.http.get<UserAdVM>(Globals.BASE_API_URL + 'User/' + id).pipe()
  }
  SearchUserAd(value: UserAdVM): Observable<UserAdVM[]> {
    return this.http.post<UserAdVM[]>(Globals.BASE_API_URL + 'User/Search', value).pipe();
  }
  GetUserAd(): Observable<UserAdVM[]> {
    return this.http.get<UserAdVM[]>(Globals.BASE_API_URL + 'User').pipe();
  }
  SaveUserAd(value: UserAdVM): Observable<any> {
    return this.http.post(Globals.BASE_API_URL + 'User', value);
  }
  DeleteUserAd(id: number) {
    return this.http.delete(Globals.BASE_API_URL + 'User/' + id);
  } */
...
// sampletypeVM lms service

GetSampletype(): Observable<SampletypeVM[]>{
  return this.http.get<SampletypeVM[]>(Globals.BASE_API_URL + 'Sampletype').pipe();
}
GetSampletypeClientId(ClientId: number): Observable<SampletypeVM[]> {
  return this.http.get<SampletypeVM[]>(Globals.BASE_API_URL + 'Sampletype/' + ClientId).pipe()
}
SaveSampletype(value:SampletypeVM){
  return this.http.post(Globals.BASE_API_URL + 'Sampletype',value);
}
UpdateSampletype(value:SampletypeVM){
  return this.http.put(Globals.BASE_API_URL + 'Sampletype',value);
}
DeleteSampletype(ClientId:number){
  return this.http.delete(Globals.BASE_API_URL + 'Sampletype/' + ClientId);
}
SearchSampletype(value:SampletypeVM): Observable<SampletypeVM[]>{
  return this.http.post<SampletypeVM[]>(Globals.BASE_API_URL + 'Sampletype/Search' ,value).pipe();
}
...
GetPage(): Observable<PageVM[]> {
  return this.http.get<PageVM[]>(Globals.BASE_API_URL + 'Page').pipe();
}
SavePage(value: PageVM) {  
  return this.http.post(Globals.BASE_API_URL + 'Page', value)
}
UpdatePage(value: PageVM) {
  return this.http.put(Globals.BASE_API_URL + 'Page', value)
}
DeletePage(id: number) {
  return this.http.delete(Globals.BASE_API_URL + 'Page/' + id)
}
SearchPage(value: PageVM): Observable<PageVM[]> {
  return this.http.post<PageVM[]>(Globals.BASE_API_URL + 'Page/Search', value).pipe();
}

GetStudentFormById(id: number): Observable<StudentFormVM> {
  return this.http.get<StudentFormVM>(Globals.BASE_API_URL + 'StudentForm/GetStudentFormById?Id=' + id).pipe()
}
GetStudentForm(): Observable<StudentFormVM[]> {  
  return this.http.get<StudentFormVM[]>(Globals.BASE_API_URL + 'StudentForm').pipe();
}
SaveStudentForm(value: StudentFormVM) {
  return this.http.post(Globals.BASE_API_URL + 'StudentForm', value)
}
UpdateStudentForm(value: StudentFormVM) {
  return this.http.put(Globals.BASE_API_URL + 'StudentForm', value)
}
DeleteStudentForm(id: number) {
  return this.http.delete(Globals.BASE_API_URL + 'StudentForm/' + id)
}
SearchStudentForm(value: StudentFormVM): Observable<StudentFormVM[]> {
  return this.http.post<StudentFormVM[]>(Globals.BASE_API_URL + 'StudentForm/Search', value).pipe();
}
...
SaveFiscalYear(value: FiscalYearVM) {
  return this.http.post(Globals.BASE_API_URL + 'FiscalYear', value)
}
UpdateFiscalYear(value: FiscalYearVM) {
  return this.http.put(Globals.BASE_API_URL + 'FiscalYear', value)
}
DeleteFiscalYear(ClientId: number) {
  return this.http.delete(Globals.BASE_API_URL + 'FiscalYear/' + ClientId)
}
SearchFiscalYear(value: FiscalYearVM): Observable<FiscalYearVM[]> {
  return this.http.post<FiscalYearVM[]>(Globals.BASE_API_URL + 'FiscalYear/Search', value).pipe();
}
