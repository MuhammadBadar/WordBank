...
import { UsersAdditionFieldsComponent } from './users-addition-fields/users-addition-fields.component';
...
export class ManageUserComponent implements OnInit {
  ...
  OpenUserAdDialog(id) {
    ...
    this.dialogRef = this.dialog.open(UsersAdditionFieldsComponent, {
      width: '1200px',
      height: '950px',
      data: {user:id }
    });
