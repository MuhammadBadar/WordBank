...
import { UsersAdditionFieldsComponent } from './manage-user/users-addition-fields/users-addition-fields.component';
...
@NgModule({
  ...
  declarations: [ManageRoleComponent, ManageUserComponent, CreateUserDialogComponent, AssignRoleToUserComponent,
     CreateUserRoleComponent, LoginComponent, ForgotPasswordComponent, OtpComponent, SignUpComponent, UsersAdditionFieldsComponent,   ],
  providers: [
    DatePipe,
