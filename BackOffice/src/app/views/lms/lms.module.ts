...
import { ManageSTDStudentComponent } from './manage-std-student/manage-std-student.component';
...
@NgModule({
  declarations: [
    ...
    ManageFeelinesPopupComponent,
     ManageFeeDetailsComponent,
     ManagepageComponent,
     ManagepatientLabTestComponent,
     ManageSTDStudentComponent,
     ManagestudentformComponent,
     ManageFiscalYearComponent,
    
     CourseComponent,
           ManageUserAdditionalfieldsComponent,
